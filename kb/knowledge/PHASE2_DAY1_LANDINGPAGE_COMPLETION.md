...
- **Key Sections:**
  - `landing.badge` - "Session Clock • Economic Calendar • NY Time"
...
- **Key Finance Terminology:**
  - Session Clock → "Horloge de Session"
...
- ❌ OLD: `Session Clock • Economic Calendar • NY Time`
- ✅ NEW: `{t('landing.badge')}`
- ❌ OLD: `Session Clock + Economic Calendar (NY Time)`
...
```javascript
// Before
<h1>Session Clock + Economic Calendar (NY Time)</h1>
