 ...
 *
 * Route: /events/:eventId (EN), /es/events/:eventId (ES), /fr/events/:eventId (FR)
 * SEO: 159 static pages (53 events × 3 languages) generated by prerender.mjs
 *
 * Changelog:
 * v1.1.0 - 2026-02-04 - BEP SEO CRITICAL: Updated event page URLs to use subpath structure (/es/events/..., /fr/events/...) instead of query params. Aligns with Firebase hosting rewrites and sitemap structure.
...
const buildEventStructuredData = (event, localizedContent, lang) => {
    ...
    const eventUrl = `${SITE_URL}${langPrefix}/events/${event.id}`;
