...
const Sidebar = ({
  ...
  // Collapsible section states (changed to false for initial state)
            ...
            <div className="sidebar-section-content">
              ...
              <div className="sidebar-control killzone-toggles">
                <div className="toggle-container">
                    <span className="toggle-label sidebar-label" title="Display the time remaining until the current killzone ends" onClick={toggleShowTimeToEnd}>
                        Show Time to End
                    </span>
                  <span
                ...
                <hr className="killzone-divider" />
                <div className="toggle-container">
                    <span className="toggle-label sidebar-label" title="Display the time until the next killzone starts" onClick={toggleShowTimeToStart}>
                        Show Time to Start
                    </span>
                  <span
          ...
          {isAboutOpen && (
            <div className="sidebar-section-content">
              <div className="sidebar-control about-text">
                <p>About the Trading Clock: This tool helps you track trading sessions with visual cues for active and upcoming killzones.</p>
              </div>
